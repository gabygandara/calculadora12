    ...
    if (st.session_state.aux2 == True): 
        with st.spinner("Cargando . . ."): 
            ...
            if tasas_a_STR == "8,260000000000002":
                    tasas_a_STR = "8,26"  
            if tasas_a_STR == "15,440000000000001":
                tasas_a_STR = "15,44"      
...
if st.checkbox("Si usted tiene alguna consulta, haga click aquí"):
    with st.form(key='consultas'):
        ...
        if boton_consulta:
            ...
            elif nombre_ingresado == "" or apellido_ingresado == "" or asunto_ingresado == "" or consulta_ingresada == "" or email_ingresado.strip() == "" or repetir_email_ingresado.strip() == "":
